...
window.CLYNIA_FORM = {
  ...
  steps: [
    ...
    // ---------- FINALES ----------
    { id: "ending_ok", type: "ending", variant: "ok", q: "¡Gracias! Tu consulta ya está con un médico", badge: "No tienes que hacer nada más", body: "Te contactamos nosotros. Esto es lo que pasa a partir de ahora:", steps: [{ t: "Consulta recibida", d: "Ya la tenemos guardada y en la cola de revisión médica.", done: true }, { t: "Un médico colegiado la revisa", d: "Mira tu caso con calma, sin cita previa y sin salas de espera." }, { t: "Te escribe por email", d: "Normalmente en menos de 24 horas. Si un tratamiento es adecuado para ti, te lo indicará y decides entonces si quieres continuar." }], ctaNote: "Mientras tanto, en nuestro blog contamos cómo cuidar tu peso con criterio médico, sin milagros ni atajos.", cta: "Ver artículos del blog", href: "/blog" },
