...
window.CLYNIA_FORM = {
  ...
  steps: [
    ...
    { id: "telefono", section: "Para tu receta", type: "tel", key: "telefono", q: "¿Y tu número de teléfono?", help: "El médico puede llamarte aquí si necesita ampliar algún dato.", showIf: function (a) { return !String(a.telefono || "").trim() && !(a._yaTenemos && a._yaTenemos.telefono); } },
    ...
    // PROMESA DE CANAL (canónica, 1 ago 2026). Ver el comentario largo en peso-schema.js: el sistema
    // solo garantiza EMAIL y la llamada es un extra del médico, nunca una promesa. Copia literal de
    // la frase de allí; si cambia una, cambiar las dos (y las 6 páginas HTML que la repiten).
